      ...
      <div id="middle">
        ...
        <div id="mid_bottom" class="box">
          <el-form ref="form" :model="form" label-width="100px">
            <el-form-item class="rule-label" label="姓名：">
              <el-input class="rule-input" v-model="form.name"></el-input>
            </el-form-item>
            <el-form-item class="rule-label" label="号码：">
              <el-input class="rule-input" v-model="form.num"></el-input>
            </el-form-item>
            <el-form-item class="rule-label" label="开户单位：">
              <el-input class="rule-input" v-model="form.com"></el-input>
            </el-form-item>
          </el-form>
        </div>
        <!-- 录音盒子 -->
        ...
        <div class="mid_mid">
          <el-button id="startbtn" ref="startbtn" :disabled="startbtnClickable"
            >开始上传</el-button
          >
        </div>
      </div>
...
/* 表单标签 */
.rule-label /deep/ .el-form-item__label {
  color: #fff;
  font-size: 16px;
  margin-top: 10px;
}
